    ...
    switch(opcion){
        case 1:{
            ...
            if(validarStock(cantidadElegida, frutas[productoElegido].stock)){
                ...
                carrito.push({producto: frutas[productoElegido].producto, cantidadElegida});
        ...
        case 2:{
            ...
            if(validarStock(cantidadElegida, almacen[productoElegido].stock)){
                ...
                carrito.push({producto: almacen[productoElegido].producto, cantidadElegida});
        ...
        case 3:{
            ...
            if(validarStock(cantidadElegida, limpieza[productoElegido].stock)){
                ...
                carrito.push({producto: limpieza[productoElegido].producto, cantidadElegida});
